...
#Задача 4 часть б
arbuz=input("арбуз больше чем дыня (да, нет, не знаю, не верю, не могу точно сказать, может быть")
if arbuz == "Да":
    print("ВСМЫСЛЕ")
elif arbuz == "не знаю":
    print("круто, я тоже")
    ...
    print("поверишь")
elif arbuz == "не могу точно сказать"
    print("А ты смоги")
elif arbuz == "может быть"
    print("Нужен точный ответ!")
else:
